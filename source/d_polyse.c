...
void D_DrawSubdivT (void);
void D_DrawSubdivT2 (void);
void D_DrawSubdivT3 (void);
void D_DrawSubdivT5 (void);
...
static void do_PolysetDrawFinalVerts (finalvert_t *pv)
{
	...
	// valid triangle coordinates for filling can include the bottom and
	// right clip edges, due to the fill rule; these shouldn't be drawn
	if ((pv->v[0] < r_refdef.vrectright) &&
		(pv->v[1] < r_refdef.vrectbottom))
	{
		z = pv->v[5]>>16;
